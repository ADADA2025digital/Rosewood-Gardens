...
const Cookies = () => {
  ...
  return (
    <div
      className={`card cookie-card bg-white d-flex flex-column align-items-center justify-content-center rounded-3 p-4 gap-3 position-fixed
...
<div className="card-header bg-transparent border-0 w-100 d-flex justify-content-end position-absolute top-0 start-0 p-2">
  ...
  ></button>
      ...
      <p className="dark-text m-0 fw-bold">We use cookies.</p>
      <p className="text-muted m-0">
        Rosewood Gardens use cookies for user experience, analytics,
        personalisation and tracking purposes. By continuing to use this website
        you agree to our <a href="/privacypolicy" className="dark-text">privacy policy</a>
      </p>
      <div className="d-flex gap-3">
        <button className="btn border text-muted rounded-pill px-4" onClick={handleAllow}>
          OK
        </button>
      </div>
    </div>
